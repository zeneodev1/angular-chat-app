...
@Component({
  selector: 'app-invitaion-dialog',
  templateUrl: './invitaion-dialog.component.html',
  styleUrls: ['./invitaion-dialog.component.css']
})
export class InvitaionDialogComponent implements OnInit {
